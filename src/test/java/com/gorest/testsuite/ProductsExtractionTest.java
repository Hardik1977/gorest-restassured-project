...
public class ProductsExtractionTest {
    ...
    //6. Extract the title of all records whose user_id = 2272684
    @Test
    public void test6() {
        List<?> allRecords = response.extract().path("findAll{it.user_id==2272684}.record");
        System.out.println("------------------StartingTest---------------------------");
        System.out.println("The title of all records whose user_id = 2272684 : " + allRecords);
        System.out.println("------------------End of Test---------------------------");
    }
    //7. Extract the body of all records whose id = 39305
    @Test

    public void test7() {
        List<?> allRecordWhoseID2670 = response.extract().path("findAll{it.id==39305}.body");
        System.out.println("------------------StartingTest---------------------------");
